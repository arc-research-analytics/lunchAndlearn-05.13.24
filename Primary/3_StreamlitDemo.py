...
# # Take a look at the data prouced by the notebook file: no filter applied
...
# # This is really similar to Excel's Pivot Table functionality
...
# # Take a look at the data: filtered THEN aggregated
...
# # define a Plotly Express choropleth Mapbox figure
